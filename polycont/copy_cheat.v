...
intro t; case t; clear t.
  ...
  intros c t1; case c; simpl in |- *; clear c.
    (* c = blue *)
    apply Mx_unit.                   (* cheating *)
    apply Mx_try with (1 := core_cop t1).
      intros (t', eg, di); exists (Nd1 red t');
       [ elim eg; trivial | simplify_eq ].
      intro eg; exists (Nd1 red t1); [ elim eg; trivial | simplify_eq ].
...
Extraction
 "copy_cheat_extr.ml" Mx_unit Mx_raise Mx_try Mx_bind core_cop eff_cop.
